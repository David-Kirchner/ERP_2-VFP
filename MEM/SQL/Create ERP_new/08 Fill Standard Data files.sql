...
BEGIN TRY
    ...
    SELECT @sql = @sql + 'ALTER TABLE [ERP_2].' + QUOTENAME(s.name) + '.' + QUOTENAME(t.name) + ' NOCHECK CONSTRAINT ALL;' + CHAR(13)
    FROM [ERP_2].sys.tables t
    INNER JOIN [ERP_2].sys.schemas s ON t.schema_id = s.schema_id;
    ...
    DELETE FROM [ERP_2].[dbo].[Alloy_AlloyCategory];
    DELETE FROM [ERP_2].[dbo].[rtr_Machine];
    -- WaterJetMachines removed from script
    
    -- Delete from parent/independent tables
    DELETE FROM [ERP_2].[dbo].[Alloy];
    DELETE FROM [ERP_2].[dbo].[Alloy_GL];
    DELETE FROM [ERP_2].[dbo].[Alloy_Spec];
    DELETE FROM [ERP_2].[dbo].[AlloyCategory];
    DELETE FROM [ERP_2].[dbo].[Alloys];
    DELETE FROM [ERP_2].[dbo].[AlloySurcharge];
    DELETE FROM [ERP_2].[dbo].[ConditionCode];
    DELETE FROM [ERP_2].[dbo].[ConditionCodeAdjust];
    DELETE FROM [ERP_2].[dbo].[ConditionLevel];
    DELETE FROM [ERP_2].[dbo].[Countries];
    DELETE FROM [ERP_2].[dbo].[District];
    DELETE FROM [ERP_2].[dbo].[District_SalesP];
    DELETE FROM [ERP_2].[dbo].[District_St];
    DELETE FROM [ERP_2].[dbo].[Forms];
    DELETE FROM [ERP_2].[dbo].[GFM_Machines];
    DELETE FROM [ERP_2].[dbo].[Hardness];
    DELETE FROM [ERP_2].[dbo].[Hardwood];
    DELETE FROM [ERP_2].[dbo].[IND_Type];
    DELETE FROM [ERP_2].[dbo].[Mach_Type];
    DELETE FROM [ERP_2].[dbo].[Melt_Type];

    DELETE FROM [ERP_2].[dbo].[OT_Job_Class]
    DELETE FROM [ERP_2].[dbo].[OT_OrderType]

    DELETE FROM [ERP_2].[dbo].[PO_StockLst_Def];
    DELETE FROM [ERP_2].[dbo].[POstatusDef];
    DELETE FROM [ERP_2].[dbo].[prc_Equipment];
    DELETE FROM [ERP_2].[dbo].[prc_Equipment_Extra_Barcodes];
    DELETE FROM [ERP_2].[dbo].[prc_ScanName];
    DELETE FROM [ERP_2].[dbo].[PU];
    DELETE FROM [ERP_2].[dbo].[rtr_Operation];
    DELETE FROM [ERP_2].[dbo].[Scan_Code];
    DELETE FROM [ERP_2].[dbo].[Spec_Check];
    DELETE FROM [ERP_2].[dbo].[Spec_tol];
    DELETE FROM [ERP_2].[dbo].[StandardSize];
    DELETE FROM [ERP_2].[dbo].[UPSshiproute];
    DELETE FROM [ERP_2].[dbo].[UPSStdShiproute];
    DELETE FROM [ERP_2].[dbo].[Weight_Flanges];
    DELETE FROM [ERP_2].[dbo].[wPipe];
    ...
    SET IDENTITY_INSERT [ERP_2].[dbo].[Alloy_Spec] OFF;
    ...
    SET IDENTITY_INSERT [ERP_2].[dbo].[AlloySurcharge] ON;
    INSERT INTO [ERP_2].[dbo].[AlloySurcharge]
    ...
    INSERT INTO [ERP_2].[dbo].[OT_OrderType]
    ...
    INSERT INTO [ERP_2].[dbo].[PO_StockLst_Def]
    ...
    SET IDENTITY_INSERT [ERP_2].[dbo].[rtr_Operation] ON;
    INSERT INTO [ERP_2].[dbo].[rtr_Operation]
    ...
    SET IDENTITY_INSERT [ERP_2].[dbo].[Spec_Check] OFF;
    PRINT 'Copied Spec_Check: ' + CAST(@@ROWCOUNT AS VARCHAR(10)) + ' rows';

    -- Spec_tol (identity: ID - last column)
    SET IDENTITY_INSERT [ERP_2].[dbo].[Spec_tol] ON;
    INSERT INTO [ERP_2].[dbo].[Spec_tol]
    ...
    INSERT INTO [ERP_2].[dbo].[UPSStdShiproute]
    ...
    INSERT INTO [ERP_2].[dbo].[Alloy_AlloyCategory]
    ...
    SET IDENTITY_INSERT [ERP_2].[dbo].[rtr_Machine] ON;
    INSERT INTO [ERP_2].[dbo].[rtr_Machine]
    ...
    SET IDENTITY_INSERT [ERP_2].[dbo].[rtr_Machine] OFF;
    ...
    SET @sql = '';
    SELECT @sql = @sql + 'ALTER TABLE [ERP_2].' + QUOTENAME(s.name) + '.' + QUOTENAME(t.name) + ' WITH CHECK CHECK CONSTRAINT ALL;' + CHAR(13)
    FROM [ERP_2].sys.tables t
    INNER JOIN [ERP_2].sys.schemas s ON t.schema_id = s.schema_id;
    EXEC sp_executesql @sql;
...
BEGIN CATCH
    ...
    SELECT @sqlErr = @sqlErr + 'ALTER TABLE [ERP_2].' + QUOTENAME(s.name) + '.' + QUOTENAME(t.name) + ' WITH CHECK CHECK CONSTRAINT ALL;' + CHAR(13)
    FROM [ERP_2].sys.tables t
    INNER JOIN [ERP_2].sys.schemas s ON t.schema_id = s.schema_id;
